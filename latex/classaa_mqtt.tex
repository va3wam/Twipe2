...
static void \mbox{\hyperlink{classaa_mqtt_ac4aec787c2d889e0b07573f100be7c22}{publish\+MQTT}} (String topic, String msg)
...
\begin{DoxyCompactList}\small\item\em Publishes messages to the health event topic on the MQTT broker. \end{DoxyCompactList}\item 
...
Definition at line 22 of file aa\+Mqtt.\+h.
...
Definition at line 43 of file aa\+Mqtt.\+cpp.
...
Definition at line 51 of file aa\+Mqtt.\+cpp.
...
Definition at line 59 of file aa\+Mqtt.\+cpp.
...
Definition at line 110 of file aa\+Mqtt.\+cpp.
...
Definition at line 131 of file aa\+Mqtt.\+cpp.
...
\end{DoxyNote}
\hypertarget{classaa_mqtt_autotoc_md37}{}\doxysubsubsection{QOS Flag}\label{classaa_mqtt_autotoc_md37}
Two bits that show the QOS level of the message. Valid values are 1, 2 and 3 \hypertarget{classaa_mqtt_autotoc_md38}{}\doxysubsubsection{Retain Flag}\label{classaa_mqtt_autotoc_md38}
Boolean value showing whether the message is saved by the broker as the last known good value for a specified topic. When a new client subscribes to a topic, they receive the last message that is retained on that topic. \hypertarget{classaa_mqtt_autotoc_md39}{}\doxysubsubsection{DUP flag}\label{classaa_mqtt_autotoc_md39}
Boolean value indicates that the message is a duplicate and was resent because the intended recipient (client or broker) did not \hypertarget{classaa_mqtt_autotoc_md40}{}\doxysubsection{acknowledge the original message. This is only relevant for Qo\+S greater than 0.}\label{classaa_mqtt_autotoc_md40}


Definition at line 245 of file aa\+Mqtt.\+cpp.
...
\hypertarget{classaa_mqtt_autotoc_md41}{}\doxysubsection{@param packet\+Id Unique identifier of the message.}\label{classaa_mqtt_autotoc_md41}


Definition at line 273 of file aa\+Mqtt.\+cpp.
...
Definition at line 164 of file aa\+Mqtt.\+cpp.
...
Definition at line 179 of file aa\+Mqtt.\+cpp.
...
Publishes messages to the health event topic on the MQTT broker. 
...
\hline
\end{DoxyParams}
\hypertarget{classaa_mqtt_autotoc_md36}{}\doxysubsection{@param String Event message.}\label{classaa_mqtt_autotoc_md36}


Definition at line 218 of file aa\+Mqtt.\+cpp.

\mbox{\Hypertarget{classaa_mqtt_ac4aec787c2d889e0b07573f100be7c22}\label{classaa_mqtt_ac4aec787c2d889e0b07573f100be7c22}} 
...
{\footnotesize\ttfamily void aa\+Mqtt\+::publish\+MQTT (\begin{DoxyParamCaption}\item[{String}]{topic,  }\item[{String}]{msg }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}
...
Definition at line 202 of file aa\+Mqtt.\+cpp.
